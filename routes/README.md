...
El selector del asistente esta limitado a modelos navegables de entorno:

- `incahuasi.glb`
- `ushnu.glb`

No usa piezas/objetos 3D del catalogo, porque esos GLB son para AR o visor de
obra, no para construir caminos de sala.
